@extends('layouts.contentLayout', ['title' => 'Update Lesson'])
    ...
    <div class="col-md-12 d-flex justify-content-center">
        <div class="card" style="width: 50rem;">
            <div class="card-header bg-primary">
                <h1 style="text-align:center;">Update Lesson</h1>
            </div>
                        ...
                        <div class="form-group ">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="lesson_name"
                                    ...
                                    placeholder="Lesson Name" value="{{ $lesson->lesson_name }}"
                        ...
                        <div class="form-group ">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="lesson_code"
                                    ...
                                    placeholder="Lesson Code" value="{{ $lesson->lesson_code }}"
