        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('teacher.lesson.show', $module->lesson_id) }}">Lesson Modules</a>
                    </li>
    ...
    <div class="col-md-12 d-flex justify-content-center">
        <div class="card" style="width: 50rem;">
            <div class="card-header bg-primary">
                <h1 style="text-align:center;">Update Module</h1>
            </div>

            <div class="card-body">
                <fieldset>
                    <form method="POST" action="{{ route('teacher.module.update', $module) }}"
